...
class GptCodeConverter():
    ...
    def __init__(self, language="CPP", model=MODEL_CHOICE_1):
        self.client = OpenAI(
        ...
        You will be provided with cpp code (delimited with XML tags <code> and </code>) and will translate it to Python code.
        Use the following step by step instructions to convert the given CPP code to Python: 
            Step 1) Use a class name that is CamelCase and class methods as snake_case.
            Step 2) Fall functions and classes, create a standard python help string and add it to the code by summarizing the code.  
