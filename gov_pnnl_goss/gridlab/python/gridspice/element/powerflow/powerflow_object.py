...
class series_reactor(link):
	...
	"""
	Units: Ohm
	Description: Resistive portion of phase A'status impedance
	"""

	phase_A_reactance=None
	"""
	Units: Ohm
	Description: Reactive portion of phase A'status impedance
	"""
	...
	"""
	Units: Ohm
	Description: Resistive portion of phase B'status impedance
	"""

	phase_B_reactance=None
	"""
	Units: Ohm
	Description: Reactive portion of phase B'status impedance
	"""
	...
	"""
	Units: Ohm
	Description: Resistive portion of phase C'status impedance
	"""

	phase_C_reactance=None
	"""
	Units: Ohm
	Description: Reactive portion of phase C'status impedance
	"""
