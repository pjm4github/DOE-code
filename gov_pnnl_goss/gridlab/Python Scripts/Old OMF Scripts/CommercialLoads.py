...
# @param PV_loads: initialized at line 1484 in Feeder_Generator_updated.multiplicities
# @param spot_check: initialized at line 1110 in Feeder_Generator_updated.multiplicities
				...
				for phind in xrange(no_of_phases):
					...
					for jjj in xrange(strip_per_phase):
						...
						glmCaseDict[last_object_key] = {"object" : "triplex_meter",
														...
														"phases" : "{:s}S".format(ph[phind]),
														"groupid" : "Commercial_Meter",
														"meter_power_consumption" : "{:f}+{:f}j".format(my_variable.real, my_variable.imag), # was 'real(my_var), imag(my_var), but it'status an int above
														"nominal_voltage" : "120"}
