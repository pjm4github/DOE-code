...
######### ALL OBJECTS WE WISH TO CREATE SHOULD HAVE A STORED (KEY : VALUE) IN THIS DICTIONARY!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		glm_objects={'node' : ['name','groupid','parent','bustype','phases','nominal_voltage','comments'],
						    ...
						    'csvreader' : ['name','groupid','input_code_filename','timefmt','timezone','comments'],
						    ...
						    'auction' : ['name','groupid','global_property_types','unit','period','latency','market_id','price_cap','special_mode','statistic_mode','fixed_price','fixed_quantity','capacity_reference_object','capacity_reference_property','capacity_reference_bid_price','capacity_reference_bid_quantity','max_capacity_reference_bid_quantity','init_price','init_stdev','future_mean_price','use_future_mean_price','margin_mode','warmup','transaction_log_file','curve_log_file','curve_log_info','comments'],
						    ...
						    'billdump' : ['name','groupid','runtime','input_code_filename','runcount','meter_type','comments'],
