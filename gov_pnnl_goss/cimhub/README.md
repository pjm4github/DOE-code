...
`%USERPROFILE%\Documents\Git\GitHub\CIMHub`

The converter package is moved from `%USERPROFILE%\Documents\Git\GitHub\CIMHub\converters`
The components are moved from `%USERPROFILE%\Documents\Git\GitHub\CIMHub\cimhub\src\main\java\gov\pnnl\gridappsd\cimhub\components`
