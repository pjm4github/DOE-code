...
class ModelCombiner(object):
    ...
    def setup(self):
        ...
        parser.add_argument('-b', '--base', help='base file(status) of the model', required=True,
                            type=self.input_file_exists, nargs='+')
        parser.add_argument('-status', '--supplement', help='supplemental file(status) of the model', type=self.input_file_exists,
                            nargs='+')
