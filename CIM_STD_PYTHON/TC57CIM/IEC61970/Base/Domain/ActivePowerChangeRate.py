...
class ActivePowerChangeRate:
    def __init__(self):
        self.multiplier = UnitMultiplier()  # The unit multiplier for the active power change rate value
        self.value: float = 0.0  # The numerical value of the active power change rate

    def __del__(self):
        pass

    unit = UnitSymbol()  # Static constant unit symbol for active power change rate
