...
class ExternalNetworkInjection(RegulatingCondEq):
    ...
    def __init__(self):
        ...
        self.governor_scd: Optional[ActivePowerPerFrequency] = None
        ...
        self.max_initial_sym_shc_current: Optional[CurrentFlow] = None  # Maximum initial symmetrical short-circuit currents (Ik" max) in A (Ik" = Sk"/(SQRT(3) Un)).
        self.max_p: Optional[ActivePower] = None  # Maximum active power of the injection.
        self.max_q: Optional[ReactivePower] = None  # Not for short circuit modelling; It is used for modelling of infeed for load flow exchange. If maxQ and minQ are not used ReactiveCapabilityCurve can be used
        ...
        self.min_initial_sym_shc_current: Optional[CurrentFlow] = None  # Minimum initial symmetrical short-circuit currents (Ik" min) in A (Ik" = Sk"/(SQRT(3) Un)). Used for short circuit data exchange according to IEC 60909
        self.min_p: Optional[ActivePower] = None  # Minimum active power of the injection.
        self.min_q: Optional[ReactivePower] = None  # Not for short circuit modelling; It is used for modelling of infeed for load flow exchange. If maxQ and minQ are not used ReactiveCapabilityCurve can be used
        ...
        self.p: Optional[ActivePower] = None  # Active power injection. Load sign convention is used, i.e. positive sign means flow out from a node. Starting value for steady state solutions.
        self.q: Optional[ReactivePower] = None  # Reactive power injection. Load sign convention is used, i.e. positive sign means flow out from a node. Starting value for steady state solutions.
