...
class ControlAreaGeneratingUnit(IdentifiedObject):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.generating_unit: Optional[GeneratingUnit] = None  # The generating unit specified for this control area. Note that a control area should include a GeneratingUnit only once.
        self.alt_generating_unit_meas: Optional[AltGeneratingUnitMeas] = None  # The link to prioritized measurements for this GeneratingUnit.
