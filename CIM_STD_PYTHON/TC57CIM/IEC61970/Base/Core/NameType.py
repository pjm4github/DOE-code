...
class NameType:
    ...
    def __init__(self) -> None:
        self.description: Optional[str] = None  # Description of the name type
        self.name: Optional[str] = None  # Name of the name type
        self.name_type_authority: Optional[NameTypeAuthority] = None  # Authority responsible for managing names of this type
